...
function SearchTicket({ onSearch }: Props) {
    ...
    function handleClearFilters() {
        ...
        setSwitches({ myTickets: false, myAreaTickets: false, assignedToMe: false });
        onSearch({
            ticketNumber: "", status: "", solvingAreaId: "",
            typeRequestId: "", categoryTicketId: "", slaId: "",
            initialDate: "", finalDate: "", myTickets: false, myAreaTickets: false, assignedToMe: false,
        });
    }
return (
