...
import "./BacklogListing.css";


type BacklogListingProps = {
  backlog: TaskSimpleDTO[];
...
function BacklogListing({ onSearch, backlog, onReload, changeSort, sort }: BacklogListingProps) {
  ...
  return (
    <>
      {/* <SearchFilterTask onSearch={onSearch} hideSprintFilter /> */}
      ...
      <table>
        <thead>
          <tr>
            ...
            <th>Responsável</th>
            <th onClick={() => changeSort("createdAt")} style={{ cursor: "pointer" }}>Criado em {getSortIcon("createdAt")}</th>
      ...
      {/* Modal Novo — cria task já com sprintId null (padrão) */}
      {isNewModalOpen && (
        <Modal
          title="Nova task"
